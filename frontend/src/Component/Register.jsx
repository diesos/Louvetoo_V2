  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!err?.response) {
        ...
        setErrMsg(
          "Enregistrement échoué, votre mail est peut-être déjà utilisé."
        );
      }
    ...
    <>
      {success ? (
        <section className="register-div">
          <h1 className="register--success">
            Enregistrement effectuée <br />
        ...
        <section>
          ...
          <form onSubmit={handleSubmit}>
            <div>
              ...
              {!validPrenom && prenom.length > 0 && (
                <p className="validation-message">
                  <FontAwesomeIcon icon={faInfoCircle} /> Doit contenir 4
                  lettres au minimum.
                </p>
              )}
            </div>
            ...
            <div>
              ...
              {!validEmail && email.length > 0 && (
                <p className="validation-message">
                  <FontAwesomeIcon icon={faInfoCircle} /> Doit être au format
                  john@doe.com.
                </p>
              )}
            </div>
            ...
            <div>
              ...
              {!validPassword && password.length > 0 && (
                <p className="validation-message">
                  ...
                  <br />
                  Doit comprendre des lettres majuscules et minuscules, <br />
            ...
            <div>
              ...
              {!validConfirmPassword && confirmPassword.length > 0 && (
                <p className="validation-message">
                  <FontAwesomeIcon icon={faTimes} /> Les mots de passe ne
                  correspondent pas.
                </p>
              )}
            </div>
            ...
            <div>
              ...
              {!validTelephone && telephone.length > 0 && (
                <p className="validation-message">
                  <FontAwesomeIcon icon={faTimes} /> Format : 0601020304 (10
                  chiffres)
                </p>
              )}
            </div>
          ...
          <Link to="/Login">
            <p className="login">Vous avez déjà un compte? Connectez-vous</p>
          </Link>
        </section>
      )}
    </>
